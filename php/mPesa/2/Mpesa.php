...
class Mpesa
{
    ...
    public static function generateSandBoxToken(){
        $consumer_key= 'umej4q7yZW5uRy8apJAntTrZKlcbGraA';
        $consumer_secret= 'LYpZgGVv4ePwSzOs';
        if(!isset($consumer_key)||!isset($consumer_secret)){
            die("please declare the consumer key and consumer secret as defined in the documentation");
        }
...
/*Mpesa::c2b("174379","CustomerPayBillOnline",3,"254740495651","tESTING");*/
$qr2 = new Mpesa();
$qr2->STKPushSimulation($short_code,$password,$TransactionType,$Amount,$PartyA,$PartyB,$phone,$CallBackURL,$AccountReference,$TransactionDesc,$Remarks);